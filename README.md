...
``` shell
curl -H "Authorization: Bearer $API_TOKEN" -A 'MyApp (yourname@example.com)' https://api.reviewly.dev/00000000-0000-0000-0000-000000000000/projects.json
```
...
All Reviewly API requests require to be authenticated by passing along the API token. You can find this token in the organization's settings page.
